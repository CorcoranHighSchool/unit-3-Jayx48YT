...
//print("The value of foo is \(foo)")
//Because foo is declare on the far loop is trying to be accussed outside it's scope
...
//X is decalered as global scope on line 14 and therefore can accussed and modified as any further restricting scope.
